...
prompt_2 = Prompt.create!(description: "How would you design a program to automatically apply to new jobs as they come up?", user: user_1)
...
prompt_4 = Prompt.create!(description: "An assassin has been hired to kill you. He's cold, mechanical, and efficient. He is the Refrigerator.", user: user_2)
prompt_5 = Prompt.create!(description: "As a paranormal investigator, nobody expects your secret: some of your best friends and advisors are ghosts.", user: user_3)
...
prompt_7 = Prompt.create!(description: "You are part of a secret organization experimenting on captured murderers and serial killers. One of your experiments involves giving one of the most brutal serial killers of your era a conscience.", user: user_1)
prompt_8 = Prompt.create!(description: "The Fellowship of the Ring has been formed to lead Frodo to Mordor - it is comprised of the famous wizard Gilderay Lockhart, Buddy the elf, sneezy dwarf, and Monty Python's King Arthur and the Black Knight...", user: user_2)
