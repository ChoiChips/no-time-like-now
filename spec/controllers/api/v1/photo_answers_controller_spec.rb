...
RSpec.describe Api::V1::PhotoAnswersController, type: :controller do
  ...
  describe "GET#show" do
    it "should return a single photo answer" do
      ...
      expect(returned_json["photo_answer"]["answer"]).to eq "This is test photo answer, written by user_1. It must be a minimum length."
      expect(returned_json["photo_answer"]["url"]).to eq "www.test.com"
